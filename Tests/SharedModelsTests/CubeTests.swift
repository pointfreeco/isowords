...
class CubeTest: XCTestCase {
  ...
  func testIsPlayable() {
    ...
    expectNoDifference(cubes.isPlayable(side: .top, index: .zero), false)
    expectNoDifference(cubes.isPlayable(side: .left, index: .zero), false)
    expectNoDifference(cubes.isPlayable(side: .right, index: .zero), false)
    ...
    expectNoDifference(cubes.isPlayable(side: .top, index: .zero), false)
    expectNoDifference(cubes.isPlayable(side: .left, index: .zero), true)
    expectNoDifference(cubes.isPlayable(side: .right, index: .zero), false)
    ...
    expectNoDifference(cubes.isPlayable(side: .top, index: .zero), false)
    expectNoDifference(cubes.isPlayable(side: .left, index: .zero), true)
    expectNoDifference(cubes.isPlayable(side: .right, index: .zero), true)
    ...
    expectNoDifference(cubes.isPlayable(side: .top, index: .zero), true)
    expectNoDifference(cubes.isPlayable(side: .left, index: .zero), true)
    expectNoDifference(cubes.isPlayable(side: .right, index: .zero), true)
  }
}
