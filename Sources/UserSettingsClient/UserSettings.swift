...
public struct UserSettings: Codable, Equatable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.sendDailyChallengeReminder = (try? container.decode(Bool.self, forKey: .sendDailyChallengeReminder)) ?? true
    self.sendDailyChallengeSummary = (try? container.decode(Bool.self, forKey: .sendDailyChallengeSummary)) ?? true
  }
}
